...
const EasterEgg = () => {
    ...
    const [easterEggIsOpen, setEasterEggIsOpen] = useState(false)

    return (
        <div className={styles.container}>
            <div className={styles.creators}>
                <span onClick={() => setEasterEggIsOpen(!easterEggIsOpen)}>
            ...
            {easterEggIsOpen && (
                <div className={styles.easter_egg}>
                    <span className={styles.easter_egg__title}>{t('special-thanks')}</span>
                    ...
                    <span className={styles.easter_egg__title}>{t('bigs-and-pigs')}</span>
                    ...
                    <div className={styles.big}>
                        ...
                        <Emote path='/emotes/OkaygeBusiness.png' alt=' OkaygeBusiness ' />
                    </div>
                    <div className={styles.big}>
